const Footer = () => {
  const socialLinks = [
    ...
    { name: 'LinkedIn', url: 'https://linkedin.com', icon: 'M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-.976-.017-2.229-1.359-2.229-1.36 0-1.569 1.061-1.569 2.158v5.675h-3v-11h3v1.561c.521-.88 1.793-1.81 3.69-1.81 3.945 0 4.69 2.596 4.69 5.97v6.279z' },
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xl font-semibold mb-4 gradient-text">Contact</h3>
            <ul className="space-y-2">
